...
public class ProjectDSLGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	...
	public class ParameterElements extends AbstractParserRuleElementFinder {
		...
		private final Keyword cOpEqualsSignEqualsSignKeyword_5_2_0_4 = (Keyword)cOpAlternatives_5_2_0.eContents().get(4);
		private final Keyword cOpEqualsSignExclamationMarkKeyword_5_2_0_5 = (Keyword)cOpAlternatives_5_2_0.eContents().get(5);
		...
		//Parameter:
		//	name=ID '=' dataType=ID ':' type+=Type+ ('require' left=MathExp op=('>=' | '<=' | '>' | '<' | '==' | '=!')
		//	right=MathExp)?;
		@Override public ParserRule getRule() { return rule; }
		...
		//'=='
		public Keyword getOpEqualsSignEqualsSignKeyword_5_2_0_4() { return cOpEqualsSignEqualsSignKeyword_5_2_0_4; }
		
		//'=!'
		public Keyword getOpEqualsSignExclamationMarkKeyword_5_2_0_5() { return cOpEqualsSignExclamationMarkKeyword_5_2_0_5; }

 ...
 *   <li>{@link org.xtext.example.mydsl.projectDSL.Parameter#getContent <em>Content</em>}</li>
 * </ul>
 *
...
public interface Parameter extends EObject
{
   ...
   * @see #setContent(MathContent)
   * @see org.xtext.example.mydsl.projectDSL.ProjectDSLPackage#getParameter_Content()
   * @model containment="true"
   * @generated
   */
  MathContent getContent();

  /**
   * Sets the value of the '{@link org.xtext.example.mydsl.projectDSL.Parameter#getContent <em>Content</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  void setContent(MathContent value);
